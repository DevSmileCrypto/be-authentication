...
public class TokenController {
    ...
    @PutMapping("/validate/{accessToken}")
    public AccountAuthenticationDto validate(@NotNull @PathVariable String accessToken) {
    ...
    public AuthenticationTokenPairDto refresh(@NotNull @PathVariable String refreshToken) {
